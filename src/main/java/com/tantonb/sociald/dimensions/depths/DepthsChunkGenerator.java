...
public class DepthsChunkGenerator extends NoiseChunkGenerator<DepthsChunkGenerator.DepthsGenSettings> {

    public static class DepthsGenSettings extends GenerationSettings {

        public static DepthsGenSettings createDefault() {
            DepthsGenSettings settings = new DepthsGenSettings();
            //settings.setDefaultBlock(Blocks.DIAMOND_BLOCK.getDefaultState());
            //settings.setDefaultFluid(Blocks.LAVA.getDefaultState());
            return settings;
        }
    }

    public DepthsChunkGenerator(IWorld world, BiomeProvider provider) {
        super(world, provider, 4, 8, 256, DepthsGenSettings.createDefault(), true);
